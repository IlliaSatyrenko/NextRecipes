...
function ItemPage({ params: { id } }: { params: { id: string } }) {
    ...
    if (currentData.current !== undefined) {
        ...
        for (let i = 1; i < 21; i++) {
            ...
            if (!currentData.current[str] || currentData.current[str] == " ") break;
        ...
        <>
            ...
            <main className={styles.main}>
                {isLoading ? (
                    ...
                    <Link href="/all-items" className={styles.itemButton} color="#ffa135">
                        All items
                    </Link>
                )}
